...
add_reference_to_stage(usd_path=gripper_usd, prim_path="/World/UR10/wrist_3_link")
gripper = SurfaceGripper(end_effector_prim_path="/World/UR10/wrist_3_link", translate=0.1611, direction="z")
ur10 = my_world.scene.add(
    SingleManipulator(
        prim_path="/World/UR10", name="my_ur10", end_effector_prim_path="/World/UR10/wrist_3_link", gripper=gripper
    )
)
